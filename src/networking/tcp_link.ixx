/**
 * @file tcp_link.ixx
 * @brief Asynchronous TCP link module for inter-switch communication
 *
...
export module MiniSonic.Networking.TcpLink;
...
public:
    ...
    // Rule of five
    TcpLinkAsync(const TcpLinkAsync& other) = delete;
    TcpLinkAsync& operator=(const TcpLinkAsync& other) = delete;
    TcpLinkAsync(TcpLinkAsync&& other) noexcept = delete;
    TcpLinkAsync& operator=(TcpLinkAsync&& other) noexcept = delete;
